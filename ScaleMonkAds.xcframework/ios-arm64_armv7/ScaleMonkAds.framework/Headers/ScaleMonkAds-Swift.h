...
@optional
- (void)onVideoAdClickWithTag:(NSString * _Nonnull)tag;
- (void)onVideoAdViewStartWithTag:(NSString * _Nonnull)tag;
- (void)onVideoAdFinishWithNoRewardWithTag:(NSString * _Nonnull)tag;
- (void)onVideoAdFinishWithRewardWithTag:(NSString * _Nonnull)tag;
- (void)onVideoAdFailWithTag:(NSString * _Nonnull)tag;
- (void)onVideoReady;
@end
...
/// Call this method <em>after</em> the user as granted consent. (GDPR).
- (void)grantConsent;
/// Call this method if the user revoked consent. (GDPR).
- (void)revokeConsent;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
